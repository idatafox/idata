...
import com.elearn007.services.teach.NoSuchEventException;
import com.elearn007.services.teach.model.Event;
import com.elearn007.services.teach.model.impl.EventImpl;
import com.elearn007.services.teach.model.impl.EventModelImpl;
...
public class EventPersistenceImpl extends BasePersistenceImpl<Event>
	...
	@Override
	public Event updateImpl(com.elearn007.services.teach.model.Event event)
		throws SystemException {
		event = toUnwrappedModel(event);
	...
	protected Event toUnwrappedModel(Event event) {
		...
		eventImpl.setDesciption(event.getDesciption());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.elearn007.services.teach.model.Event")));
