...
import com.elearn007.services.teach.service.ClpSerializer;
...
public class EventClp extends BaseModelImpl<Event> implements Event {
	...
	public void setDesciption(String desciption) {
		...
		if (_eventRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setDesciption", String.class);

				method.invoke(_eventRemoteModel, desciption);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public Object clone() {
		...
		clone.setDesciption(getDesciption());
