...
import com.elearn007.services.teach.model.EventClp;
import com.elearn007.services.teach.model.LocationClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"elearn007-servicedemo-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "elearn007-servicedemo-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.elearn007.services.teach.model.impl.EventImpl")) {
			return translateOutputEvent(oldModel);
		}

		if (oldModelClassName.equals(
					"com.elearn007.services.teach.model.impl.LocationImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"com.elearn007.services.teach.NoSuchEventException")) {
			return new com.elearn007.services.teach.NoSuchEventException();
		}

		if (className.equals(
					"com.elearn007.services.teach.NoSuchLocationException")) {
			return new com.elearn007.services.teach.NoSuchLocationException();
		}
